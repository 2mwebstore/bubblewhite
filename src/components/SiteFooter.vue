...
const socials = [
  ...
  { label: 'TikTok', href: '#', fallback: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M14 3c.3 2 1.8 3.6 4 3.9V9.9c-1.5 0-2.9-.5-4-1.3v6.6a5.2 5.2 0 11-4.4-5.1v3a2.2 2.2 0 102.2 2.2V3H14z"/></svg>' },
